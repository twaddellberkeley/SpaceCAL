...
public:
  ...
  : Node("bag_recorder")
  {
    const rosbag2_cpp::StorageOptions storage_options({"my_bag2", "sqlite3"});
    ...
    subscription_ = create_subscription<std_msgs::msg::String>(
      "buttons_toppic", 10, std::bind(&BagRecorder::topic_callback, this, _1));
  }
...
private:
  void topic_callback(std::shared_ptr<rclcpp::SerializedMessage> msg) const
  {
    ...
    *bag_message->serialized_data = msg->release_rcl_serialized_message();
    ...
    bag_message->topic_name = "buttons_topic";
