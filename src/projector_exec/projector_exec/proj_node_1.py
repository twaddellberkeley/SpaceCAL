...
class ProjectorNode(Node):
    ...
    def __init__(self):
        super().__init__('projector_node_1')
        self.proj_srv = self.create_service(Projector, 'projector_srv_1', self.projector_exec_callback)
    ...
    def projector_exec_callback(self, request, response):
        ...
        time.sleep(5)
        response.err = 0
        response.msg = "Projector 1 executed succesfully"
...
def main(args=None):
    print('Hi from projector_exec 1.')
