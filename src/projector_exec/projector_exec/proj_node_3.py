...
class ProjectorNode(Node):
    ...
    def __init__(self):
        super().__init__('projector_node_3')
        self.proj_srv = self.create_service(Projector, 'projector_srv_3', self.projector_exec_callback)
    ...
    def projector_exec_callback(self, request, response):
        ...
        time.sleep(5)
        response.err = 0
        response.msg = "Projector 3 executed succesfully"
...
def main(args=None):
    print('Hi from projector_exec 3.')
